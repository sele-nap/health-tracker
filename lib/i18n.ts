...
export const en = {
  ...
  dashboard: {
    ...
    streak: (n: number) => `🔥 ${n} consecutive day${n === 1 ? '' : 's'}`,
    medications: 'Medications',
  ...
  symptoms: {
    ...
    entriesCount: (n: number) => `${n} entr${n === 1 ? 'y' : 'ies'} recorded`,
    addEntry: 'Add',
  ...
  appointments: {
    ...
    summaryPlaceholder:
      'What was discussed, next steps, updated prescriptions…',
    titleLabel: 'Title',
    doctorLabel: 'Doctor',
  ...
  conditions: {
    ...
    customSymptomsDesc:
      'Add symptoms specific to this condition to track them in your daily log.',
    deleteSymptomConfirm:
      'Delete this symptom? Existing log entries will be preserved.',
  ...
  patterns: {
    ...
    correlationsEmpty:
      'Not enough data to detect patterns yet. Keep logging for at least 7 days!',
    exportData: 'Export data',
    exportDataDesc:
      'Download your complete health history as CSV files, ready for Excel or Google Sheets.',
...
export const fr: typeof en = {
  ...
  conditions: {
    ...
    customSymptomsDesc:
      'Ajoutez des symptômes propres à cette condition pour les suivre dans votre journal quotidien.',
    deleteSymptomConfirm:
      'Supprimer ce symptôme ? Les entrées existantes seront conservées.',
    backToConditions: '← Conditions',
  },
  ...
  patterns: {
    ...
    correlationsSubtitle:
      'Calculées à partir de vos 30 derniers jours de journal.',
    correlationsEmpty:
      'Pas encore assez de données pour détecter des patterns. Continuez à journaliser au moins 7 jours !',
    exportData: 'Exporter les données',
    exportDataDesc:
      "Téléchargez l'historique complet de votre santé en CSV, prêt pour Excel ou Google Sheets.",
  ...
  settings: {
    ...
    twoFactorEnabledDesc:
      "Votre compte est protégé par l'authentification TOTP.",
